# Australium
![Preview](https://i.imgur.com/PNNBAqk.png)

Port of the Australis theme from Firefox 29 and above to Pale Moon and Interlink.
...
## Download
You can grab the latest release either from the Releases section of this repository, or the [Pale Moon Add-Ons Site](https://addons.palemoon.org/addon/australium/).
